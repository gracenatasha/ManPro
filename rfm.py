...
try:
    ...
    if connection.is_connected():
            ...
            for i in recency_array:
                if (i is not None):
                    normalized_recency_arr.append(
                        (i-recency_min)/(recency_max - recency_min)*5)
                else:
        ...
        if (frequency_max == frequency_min):
            ...
            for i in frequency_array:
                if (i is not None):
                    normalized_frequency_arr.append(
                        (i-frequency_min)/(frequency_max - frequency_min)*5)
                else:
        ...
        if (monetary_max == monetary_min):  # kalo datanya sama, jd gabisa dicari minmax normalization nya
            ...
            for i in monetary_array:
                if (i is not None):
                    normalized_monetary_arr.append(
                        (i-monetary_min)/(monetary_max - monetary_min)*5)
                else:
