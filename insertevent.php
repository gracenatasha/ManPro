...
<html>
    ...
    <body style="font-family: 'Poppins', sans-serif; font-size: 20px;">
        ...
        <div class="content" style=" padding-top: 12px; padding-bottom: 8px;">
            ...
            <hr>
            <br>
            <form action="inserting_event.php" method="post">
                <!--insert nama event-->
                ...
                <input type="date" name="tanggal_event" id="tanggalEvent">
                <br>
                <label for="waktuEventMulai">Waktu Event:</label>
                <input type="time" name="waktu_event_mulai" id="waktuEventMulai">
                <label for="waktuEventAkhir"> - </label>
                <input type="time" name="waktu_event_akhir" id="waktuEventAkhir">
                <br>
                ...
                <br>
                <a href="insertLokasi.php">create location+</a>
                <br>
