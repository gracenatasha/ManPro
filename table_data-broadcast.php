  ...
  <?php
   include 'connection.php';
                    ...
                    while($row = mysqli_fetch_array($result)) {
                      ...
                      echo '<tr>';
                      // echo '<td><input type="checkbox" name="check_list[]" value="idpendonor"></td>';
                      echo '<td><input type="checkbox" name="check_list[]" value="'.$row['id_pendonor'].'"></td>';
